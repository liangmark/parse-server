...
describe_only(() => {
  ...
  fit('redis performance test', async () => {
    ...
    object.set('foo', 'bar');
    await object.save();
    expect(getSpy.calls.count()).toBe(18);
    expect(putSpy.calls.count()).toBe(8);
    getSpy.calls.reset();
    putSpy.calls.reset();
    ...
    object.set('foo', 'barz');
    await object.save();
    expect(getSpy.calls.count()).toBe(5);
    ...
    expect(putSpy.calls.count()).toBe(4);
    getSpy.calls.reset();
    putSpy.calls.reset();
    ...
    expect(getSpy.calls.count()).toBe(324);
    expect(putSpy.calls.count()).toBe(44);
    getSpy.calls.reset();
    putSpy.calls.reset();
